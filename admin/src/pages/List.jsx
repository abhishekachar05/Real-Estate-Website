        ...
        <div className="flex items-center gap-1.5">
          <Link to={`/update/${property._id}`}>
            <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}
              className="p-2 bg-[#FFFFFF] border border-[#E2E8F0] text-[#5A5856] rounded-lg hover:border-[#2563EB] hover:text-[#2563EB] transition-all duration-200">
...
const PropertyListRow = ({ property, onRemove }) => (
  <motion.div
    ...
    exit={{ opacity: 0, x: -10 }}
    className="flex items-center gap-4 p-4 bg-white rounded-xl border border-[#E2E8F0] hover:border-[#2563EB]/30 hover:shadow-card transition-all duration-200"
  >
    {/* Thumbnail */}
        ...
        <motion.div initial={{ opacity: 0, y: -16 }} animate={{ opacity: 1, y: 0 }}
          ...
          <div className="flex items-center gap-2">
            <motion.button onClick={handleRefresh} disabled={refreshing}
              ...
              className="flex items-center gap-2 px-4 py-2.5 bg-white border border-[#E2E8F0] text-[#1C1B1A] rounded-xl text-sm font-medium hover:border-[#2563EB] hover:text-[#2563EB] transition-all shadow-card disabled:opacity-60">
          ...
          <div className="flex flex-col sm:flex-row gap-3 items-start sm:items-center">
            ...
            <div className="relative flex-1 w-full">
              ...
              <input type="text" placeholder="Search properties..."
                ...
                className="w-full pl-9 pr-4 py-2.5 bg-[#FFFFFF] border border-[#E2E8F0] rounded-xl text-sm text-[#1C1B1A] placeholder-[#9CA3AF] outline-none focus:border-[#2563EB] focus:ring-2 focus:ring-[#2563EB]/15 transition-all" />
            </div>
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              <select value={sortBy} onChange={(e) => setSortBy(e.target.value)}
                className="px-3 py-2.5 bg-[#FFFFFF] border border-[#E2E8F0] rounded-xl text-xs text-[#5A5856] outline-none focus:border-[#2563EB] transition-all cursor-pointer">
