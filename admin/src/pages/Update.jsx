        ...
        <motion.form initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}
          ...
          <div className="bg-white rounded-2xl p-6 border border-[#E2E8F0] shadow-card">
            ...
            <label htmlFor="images"
              className="flex flex-col items-center justify-center w-full h-28 border-2 border-dashed border-[#E2E8F0] rounded-xl cursor-pointer bg-[#FFFFFF] hover:border-[#2563EB] hover:bg-[#2563EB]/5 transition-all duration-200 group">
          ...
          <div className="flex gap-3">
            ...
            <motion.button type="submit" disabled={loading}
              ...
              className="flex-1 flex items-center justify-center gap-2 py-4 bg-[#1C1B1A] hover:bg-[#2563EB] text-[#FFFFFF] rounded-xl font-semibold text-base transition-all duration-300 shadow-lg hover:shadow-terracotta disabled:opacity-60 disabled:cursor-not-allowed">
