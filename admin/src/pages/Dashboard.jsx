...
const KPICard = ({ label, value, sub, icon: Icon, accent, index }) => (
  <motion.div
    ...
    className={cn(
      ...
      accent ? "border-[#2563EB]/25 shadow-[inset_0_0_0_1px_rgba(37, 99, 235,0.15)]" : "border-[#E8E7E5]"
    )}
  >
    <div className="flex items-start justify-between mb-3">
      <p className="text-xs font-medium text-[#9B9B99] uppercase tracking-wider">{label}</p>
      <div className={cn("w-7 h-7 rounded-lg flex items-center justify-center", accent ? "bg-[#2563EB]/10" : "bg-[#F5F5F3]")}>
        <Icon className={cn("w-3.5 h-3.5", accent ? "text-[#2563EB]" : "text-[#9B9B99]")} />
      </div>
    </div>
...
const activityConfig = (item) => {
  ...
  return { color: "#2563EB", Icon: Activity, label: "Action" };
};
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-white border border-[#E8E7E5] text-[#6B6B6A] rounded-lg text-sm font-medium hover:border-[#2563EB] hover:text-[#2563EB] active:scale-[0.97] transition-all duration-150 disabled:opacity-50 shadow-sm"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          >
            <div className="flex items-center justify-between mb-5">
              ...
              <Link
                to="/activity-logs"
                className="text-xs text-[#2563EB] hover:text-[#C05E44] font-medium transition-colors flex items-center gap-1"
              >
