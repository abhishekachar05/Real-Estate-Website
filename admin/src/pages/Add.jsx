...
const inputClass = "w-full px-4 py-3 bg-white border border-[#E2E8F0] rounded-xl text-[#1C1B1A] placeholder-[#9CA3AF] text-sm transition-all duration-200 outline-none focus:border-[#2563EB] focus:ring-2 focus:ring-[#2563EB]/15";
    ...
    <div className="min-h-screen pt-8 pb-12 px-4 bg-[#FFFFFF]">
      <div className="max-w-3xl mx-auto">
        ...
        >
          ...
          <p className="text-[#5A5856]">Fill in the details to list a new property on Propert-E</p>
        </motion.div>
        ...
        >
                  ...
                  <button key={amenity} type="button" onClick={() => handleAmenityToggle(amenity)}
                    className={cn(
                      ...
                      selected
                        ...
                        : 'bg-[#FFFFFF] text-[#5A5856] border border-[#E2E8F0] hover:border-[#2563EB] hover:text-[#2563EB]'
                    )}
                  >
          ...
          <div className="bg-white rounded-2xl p-6 border border-[#E2E8F0] shadow-card">
            ...
            {previewUrls.length < 4 && (
              <label htmlFor="images"
                className="flex flex-col items-center justify-center w-full h-36 border-2 border-dashed border-[#E2E8F0] rounded-xl cursor-pointer bg-[#FFFFFF] hover:border-[#2563EB] hover:bg-[#2563EB]/5 transition-all duration-200 group">
          ...
          <motion.button
            ...
            className="w-full py-4 bg-[#1C1B1A] hover:bg-[#2563EB] text-[#FFFFFF] rounded-xl font-semibold text-base transition-all duration-300 shadow-lg hover:shadow-terracotta disabled:opacity-60 disabled:cursor-not-allowed"
          >
