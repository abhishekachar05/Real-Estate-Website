    ...
    >
      ...
      <div className="p-5">
        ...
        <div className="flex flex-wrap items-center gap-3 mb-3">
          <span className="font-space-mono font-bold text-[#2563EB] text-base tabular-nums">
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="flex items-start justify-between mb-6">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-[#6B6B6A] bg-white border border-[#E8E7E5] rounded-lg hover:border-[#2563EB] hover:text-[#2563EB] active:scale-[0.97] transition-all shadow-sm"
          >
        ...
        {listings.length > 0 && (
          <div className="relative mb-6">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 bg-white border border-[#E8E7E5] rounded-xl text-sm text-[#111110] focus:outline-none focus:ring-2 focus:ring-[#2563EB]/20 focus:border-[#2563EB] transition-all"
            />
          </div>
        )}
