      ...
      <div className="min-h-screen bg-[#F5F5F3] flex items-center justify-center">
        <div className="text-center max-w-sm">
          ...
          <button onClick={() => fetchUsers()}
            className="px-5 py-2.5 bg-[#2563EB] text-white rounded-lg text-sm font-medium hover:bg-[#C05E44] active:scale-[0.98] transition-all">
            Try Again
          </button>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-start justify-between mb-6">
          ...
          <button
            ...
            disabled={refreshing}
            className="flex items-center gap-2 px-4 py-2 bg-white border border-[#E8E7E5] text-[#6B6B6A] rounded-lg text-sm font-medium hover:border-[#2563EB] hover:text-[#2563EB] active:scale-[0.97] transition-all shadow-sm disabled:opacity-50"
          >
              ...
              >
                ...
                {tab.count !== undefined && (
                  <span className={cn(
                    ...
                    statusFilter === tab.key ? "bg-[#2563EB]/10 text-[#2563EB]" : "bg-[#F5F5F3] text-[#9B9B99]"
                  )}>
                    {tab.count ?? 0}
                  </span>
                )}
          ...
          <div className="flex gap-3 px-5 py-3.5">
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 border border-[#E8E7E5] rounded-lg text-sm text-[#111110] placeholder:text-[#9B9B99] focus:outline-none focus:ring-2 focus:ring-[#2563EB]/15 focus:border-[#2563EB] transition-all"
              />
            </div>
            <select
              value={sortBy}
              onChange={(e) => { setSortBy(e.target.value); setCurrentPage(1); }}
              className="px-3 py-2 border border-[#E8E7E5] rounded-lg bg-white text-sm text-[#6B6B6A] focus:outline-none focus:border-[#2563EB] transition-all"
            >
                ...
                <tr className="border-b border-[#F0EFED]">
                  <th className="pl-5 pr-3 py-3 text-left">
                    <input
                      ...
                      className="w-4 h-4 rounded border-[#D0CFCE] accent-[#2563EB] cursor-pointer"
                    />
                  </th>
