      ...
      >
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-16">
            ...
            <div>
              <div className="text-xl font-bold text-[#FFFFFF]">Propert-E</div>
        ...
        <div className="relative z-10 flex items-center gap-2 text-xs text-[#5A5856]">
          ...
          <span>Secured with 256-bit encryption • Propert-E © 2025</span>
        </div>
      </motion.div>
      ...
      >
        <div className="w-full max-w-md">
          ...
          <div className="flex items-center gap-3 mb-10 lg:hidden">
            ...
            <div className="text-lg font-bold text-[#1C1B1A]">Propert-E Admin</div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <motion.button
              ...
              className="w-full flex items-center justify-center gap-2.5 bg-[#1C1B1A] hover:bg-[#2563EB] text-[#FFFFFF] py-3.5 px-6 rounded-xl font-semibold text-sm transition-all duration-300 shadow-lg hover:shadow-terracotta disabled:opacity-60 disabled:cursor-not-allowed mt-2"
            >
              {loading ? (
                <>
