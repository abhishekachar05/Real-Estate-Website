    ...
    return (
      <div className="min-h-screen bg-[#FFFFFF]">
        ...
        <div className="max-w-xl mx-auto px-4 py-24 text-center">
          ...
          <h2 className="font-fraunces text-3xl font-bold text-[#0F172A] mb-3">Listing Submitted!</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link
              to="/my-listings"
              className="bg-[#2563EB] text-white font-manrope font-semibold px-6 py-3 rounded-lg hover:bg-[#1D4ED8] transition-[background-color]"
            >
              View My Listings
            </Link>
            <Link
              to="/properties"
              className="border border-[#2563EB] text-[#2563EB] font-manrope font-semibold px-6 py-3 rounded-lg hover:bg-[#2563EB] hover:text-white transition-[background-color,color]"
            >
              Browse Properties
            </Link>
          </div>
    ...
    <div className="min-h-screen bg-[#FFFFFF]">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  <label
                    ...
                    className={`flex items-center gap-2 p-3 rounded-lg border cursor-pointer transition-[background-color,border-color] select-none ${
                      checked
                        ...
                        : 'border-[#E2E8F0] text-[#374151] hover:border-[#2563EB]/50'
                    }`}
                  >
                    <input
                      type="checkbox"
          ...
          {/* ── Images ── */}
          <section className="bg-white border border-[#E2E8F0] rounded-2xl p-6">
            <h2 className="font-fraunces text-xl font-semibold text-[#0F172A] mb-1">
          ...
          <button
            type="submit"
            disabled={submitting}
            className="w-full bg-[#2563EB] text-white font-manrope font-semibold text-base py-3.5 rounded-xl hover:bg-[#1D4ED8] transition-[background-color] disabled:opacity-60 disabled:cursor-not-allowed"
          >
            {submitting ? (
