...
const GITHUB_URL = 'https://github.com/abhishekachar05/Real-Estate-Website';
  ...
  return (
    <div className="bg-[#FFFFFF]">
      ...
      <section className="relative bg-[#0F172A] overflow-hidden">
        {/* Decorative blurs */}
        <div className="absolute top-20 right-20 w-80 h-80 bg-[rgba(37, 99, 235,0.15)] rounded-full blur-[80px]" />
        <div className="absolute bottom-10 left-10 w-60 h-60 bg-[rgba(37, 99, 235,0.1)] rounded-full blur-[60px]" />

        <div className="max-w-[1280px] mx-auto px-8 pt-32 pb-20 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            {/* Badge */}
            <div className="inline-flex items-center gap-3 bg-[rgba(37, 99, 235,0.15)] border border-[rgba(37, 99, 235,0.3)] rounded-full px-5 py-2.5 mb-8">
              <span className="font-material-icons text-[#2563EB] text-lg" aria-hidden="true">smart_toy</span>
            ...
            <p data-speakable className="font-manrope text-lg text-[#9ca3af] leading-relaxed mb-10 max-w-2xl mx-auto">
              Search for flats, villas, and apartments across India using AI. Propert-E's AI Property Hub
            ...
            {/* Info Banner */}
            <div className="bg-[rgba(37, 99, 235,0.1)] border border-[rgba(37, 99, 235,0.25)] rounded-2xl p-6 max-w-xl mx-auto">
              <div className="flex items-start gap-3">
                <span className="font-material-icons text-[#2563EB] text-xl mt-0.5" aria-hidden="true">info</span>
      ...
      <section className="max-w-[1280px] mx-auto px-8 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, index) => (
            <div
              key={index}
              className="bg-white border border-[#E2E8F0] rounded-2xl p-6 hover:shadow-lg hover:border-[#2563EB]/30 transition-all group"
            >
              <div className="w-12 h-12 bg-[rgba(37, 99, 235,0.1)] rounded-xl flex items-center justify-center mb-4 group-hover:bg-[#2563EB] transition-[background-color]">
                <span className="font-material-icons text-[#2563EB] group-hover:text-white transition-[color]" aria-hidden="true">
                  {feature.icon}
                </span>
              </div>
        ...
        <div className="max-w-[1280px] mx-auto px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {steps.map((item) => (
              <div key={item.step} className="bg-white rounded-2xl p-6 border border-[#E2E8F0]">
                ...
                <code className="block bg-[#0F172A] text-[#2563EB] font-space-mono text-xs rounded-lg p-3 overflow-x-auto">
                  {item.command}
                </code>
              </div>
            ))}
          ...
          <div className="text-center mt-12">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-3 bg-[#0F172A] text-white font-manrope font-bold px-8 py-4 rounded-xl hover:bg-[#3a2419] transition-all shadow-lg hover:shadow-xl"
            >
