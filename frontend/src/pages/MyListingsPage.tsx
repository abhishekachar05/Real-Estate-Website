    ...
    return (
      <div className="min-h-screen bg-[#FFFFFF]">
        ...
        <div className="max-w-xl mx-auto px-4 py-24 text-center">
          ...
          <h2 className="font-fraunces text-3xl font-bold text-[#0F172A] mb-3">No listings yet</h2>
          ...
          <Link
            to="/add-property"
            className="inline-block bg-[#2563EB] text-white font-manrope font-semibold px-8 py-3 rounded-xl hover:bg-[#1D4ED8] transition-[background-color]"
          >
            + List a Property
          </Link>
        </div>
    ...
    <div className="min-h-screen bg-[#FFFFFF]">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
          <div>
            <h1 className="font-fraunces text-4xl font-bold text-[#0F172A]">My Listings</h1>
          ...
          <Link
            to="/add-property"
            className="inline-flex items-center gap-2 bg-[#2563EB] text-white font-manrope font-semibold px-5 py-2.5 rounded-xl hover:bg-[#1D4ED8] transition-[background-color] self-start sm:self-auto"
          >
          ...
          {(['active', 'pending', 'rejected', 'expired'] as const).map((status) => {
            ...
            return (
              <div key={status} className="bg-white border border-[#E2E8F0] rounded-xl p-4">
                ...
                <p className="font-fraunces text-2xl font-bold text-[#0F172A]">{counts[status]}</p>
              </div>
            );
          })}
        </div>
                ...
                <div className="flex-1 p-5 flex flex-col justify-between gap-3">
                  <div>
                    ...
                    <div className="flex flex-wrap items-start justify-between gap-2 mb-1">
                      <h3 className="font-fraunces text-lg font-semibold text-[#0F172A] leading-snug">
                        {listing.title}
                      </h3>
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-3 pt-1 border-t border-[#F3EDE8]">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Link
                        ...
                        className="flex items-center gap-1.5 font-manrope text-xs font-semibold text-[#374151] border border-[#E2E8F0] px-3 py-1.5 rounded-lg hover:border-[#2563EB] hover:text-[#2563EB] transition-[border-color,color]"
                      >
      ...
      <AlertDialog open={!!deleteTarget} onOpenChange={(open: boolean) => !open && setDeleteTarget(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              <strong className="text-[#0F172A]">{deleteTarget?.title}</strong> will be permanently
