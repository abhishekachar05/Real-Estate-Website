        ...
        <div className="bg-white border border-[#E2E8F0] rounded-2xl p-8 shadow-xl">
          {isSuccess ? (
            ...
            <>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-[#F8FAFC] border border-[#E2E8F0] rounded-xl pl-12 pr-12 py-3.5 font-manrope text-sm text-[#0F172A] placeholder:text-[#9CA3AF] focus:outline-none focus:border-[#2563EB] focus:ring-1 focus:ring-[#2563EB] transition-all"
                      required
                    />
                    <button
                      type="button"
              ...
              <Link
                to="/signin"
                className="flex items-center justify-center gap-2 mt-6 font-manrope font-medium text-sm text-[#64748B] hover:text-[#2563EB] transition-[color]"
              >
