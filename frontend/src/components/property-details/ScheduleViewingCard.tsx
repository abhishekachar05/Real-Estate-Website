...
const INPUT = "w-full bg-white/10 border border-white/15 rounded-xl px-4 py-3 font-manrope text-sm text-white placeholder:text-white/40 focus:outline-none focus:border-[#2563EB] transition-[border-color]";
...
const ScheduleViewingCard: React.FC<ScheduleViewingCardProps> = ({ property, price }) => {
  ...
  return (
    <div className="sticky top-24 bg-[#0F172A] rounded-2xl overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.25)]">
      {/* Price header */}
      <div className="px-6 pt-6 pb-5 border-b border-white/10">
        <p className="font-manrope text-xs text-white/50 uppercase tracking-wider mb-1">Listed Price</p>
        {price && (
          <p className="font-fraunces text-3xl font-bold text-[#2563EB] tabular-nums leading-none">
            {price}
          </p>
        )}
      </div>
          ...
          {success ? (
            ...
            >
              ...
              <button
                ...
                className="font-manrope text-sm text-[#2563EB] hover:text-[#E8917A] transition-colors"
              >
              ...
              <form onSubmit={handleSubmit} className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div>
                    ...
                    >
                      <option value="" className="bg-[#0F172A]">Pick time</option>
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="w-full mt-2 bg-[#2563EB] hover:bg-[#1E40AF] disabled:opacity-50 text-white font-manrope font-bold text-sm py-3.5 rounded-xl transition-all active:scale-[0.98] shadow-lg"
                >
