...
const PropertyHeader: React.FC<PropertyHeaderProps> = ({
  ...
  return (
    <div className="max-w-[1280px] mx-auto px-6 lg:px-8 pt-8 pb-0">
      ...
      {/* Name */}
      <h1 className="font-fraunces text-3xl md:text-4xl font-semibold text-[#0F172A] leading-tight mb-2 text-wrap-balance">
        {name}
      </h1>

      {/* Location */}
      <div className="flex items-center gap-1.5 mb-5">
        <MapPin className="w-4 h-4 text-[#2563EB] shrink-0" aria-hidden />
