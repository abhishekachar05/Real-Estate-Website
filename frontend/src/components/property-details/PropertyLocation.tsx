    ...
    <div className="mb-12">
      ...
      <div className="bg-white border border-[#E2E8F0] rounded-xl p-6 mb-6">
        <div className="flex items-start gap-4">
          <div className="w-10 h-10 bg-[rgba(37, 99, 235,0.1)] rounded-full flex items-center justify-center flex-shrink-0">
          ...
          {googleMapLink && (
            <a
              ...
              className="inline-flex items-center gap-1.5 text-[#2563EB] hover:text-[#1D4ED8] font-manrope text-sm font-medium shrink-0 transition-[color]"
            >
              Open in Maps
        ...
        {hasMap ? (
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-[#F8FAFC] to-[#E2E8F0] flex flex-col items-center justify-center gap-3">
            <div className="w-16 h-16 bg-white/80 rounded-full flex items-center justify-center shadow-sm">
              <MapPin className="w-8 h-8 text-[#2563EB]/60" />
            </div>
