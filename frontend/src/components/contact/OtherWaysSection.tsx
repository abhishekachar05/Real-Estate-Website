  ...
  const methods: ContactMethod[] = [
    {
      ...
      action: 'Start Chat',
      actionLink: 'https://wa.me/918296540658',
      bgColor: 'bg-[#E8F5E9]'
    },
    {
      icon: 'chat_bubble',
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {methods.map((method, index) => (
            ...
            >
              ...
              {/* Title */}
              <h3 className="font-syne font-bold text-xl text-[#0F172A] mb-3">
                {method.title}
              </h3>
              ...
              <a 
                ...
                className="inline-flex items-center gap-2 font-manrope font-bold text-sm text-[#2563EB] hover:text-[#1E40AF] transition-[color] group"
              >
