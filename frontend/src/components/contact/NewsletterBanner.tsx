            ...
            {state === 'success' ? (
              ...
              <form onSubmit={handleSubmit} className="flex gap-3">
                ...
                <button
                  ...
                  className="bg-white hover:bg-[#F2EFE9] disabled:opacity-60 disabled:cursor-not-allowed text-[#1E40AF] font-manrope font-bold text-base px-8 py-3.5 rounded-xl transition-[background-color] shadow-lg hover:shadow-xl whitespace-nowrap"
                >
