      ...
      <div className="max-w-[1280px] mx-auto px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            <div className="border-2 border-[rgba(37, 99, 235,0.2)] rounded-2xl p-4">
              <img
                src={teamImage}
          ...
          <div className="space-y-12">
            ...
            <div className="flex gap-4">
              <div className="flex-shrink-0">
                <div className="w-12 h-12 bg-white rounded-lg shadow-[0px_4px_6px_-1px_rgba(0,0,0,0.1)] flex items-center justify-center">
                  <span className="font-material-icons text-2xl text-[#2563EB]" aria-hidden="true">verified_user</span>
                </div>
              </div>
              <div>
            ...
            <div className="flex gap-4">
              <div className="flex-shrink-0">
                <div className="w-12 h-12 bg-white rounded-lg shadow-[0px_4px_6px_-1px_rgba(0,0,0,0.1)] flex items-center justify-center">
                  <span className="font-material-icons text-2xl text-[#2563EB]" aria-hidden="true">support_agent</span>
                </div>
              </div>
              <div>
            ...
            <div className="flex gap-4">
              <div className="flex-shrink-0">
                <div className="w-12 h-12 bg-white rounded-lg shadow-[0px_4px_6px_-1px_rgba(0,0,0,0.1)] flex items-center justify-center">
                  <span className="font-material-icons text-2xl text-[#2563EB]" aria-hidden="true">savings</span>
                </div>
              </div>
              <div>
