  ...
  return (
    <section className="relative bg-[#FFFFFF] pt-20 pb-32 overflow-hidden">
        ...
        <motion.div
          ...
          className="absolute right-0 top-14 w-64 h-64 bg-[rgba(29, 78, 216,0.1)] rounded-full blur-[32px]"
        />
        <motion.div
          animate={prefersReducedMotion ? {} : {
            scale: [1, 1.1, 1],
          ...
          className="absolute left-[738px] bottom-22 w-64 h-64 bg-[rgba(59,130,246,0.12)] rounded-full blur-[32px]"
        />
        ...
        <div className="max-w-[1280px] mx-auto px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              {/* Badge */}
              <motion.div variants={itemVariants} className="inline-flex items-center gap-3 bg-[rgba(37, 99, 235,0.1)] border border-[rgba(37, 99, 235,0.2)] rounded-full px-4 py-2 mb-10">
              ...
              <motion.p data-speakable variants={itemVariants} className="font-manrope font-light text-xl leading-7 text-[#4b5563] mb-12 max-w-[676px]">
                ...
                Propert-E uses AI-powered search and live market analysis to match you with the right property.
              </motion.p>

              {/* CTA Buttons */}
              <motion.div variants={itemVariants} className="flex flex-wrap gap-4 mb-10">
                <Link to="/properties" className="bg-[#2563EB] text-white font-manrope font-bold text-lg px-8 py-4 rounded-xl shadow-[0px_10px_15px_-3px_rgba(37, 99, 235,0.25),0px_4px_6px_-4px_rgba(37, 99, 235,0.25)] hover:bg-[#1D4ED8] transition-all hover:shadow-xl inline-flex items-center">
                  Explore Properties
                ...
                <Link to="/ai-hub" className="border-2 border-[#d1d5db] text-[#374151] font-manrope font-bold text-lg px-8 py-4 rounded-xl hover:border-[#2563EB] hover:text-[#2563EB] transition-all inline-flex items-center">
                  <span className="font-material-icons text-2xl text-[#2563EB] mr-2" aria-hidden="true">smart_toy</span>
              ...
              <motion.div variants={itemVariants} className="flex items-center gap-4">
                <div className="flex -space-x-2">
                  <img src={propertyImages[0]} alt="" className="w-10 h-10 rounded-full border-2 border-[#FFFFFF] object-cover" />
                  <img src={propertyImages[1]} alt="" className="w-10 h-10 rounded-full border-2 border-[#FFFFFF] object-cover" />
                  <img src={propertyImages[2]} alt="" className="w-10 h-10 rounded-full border-2 border-[#FFFFFF] object-cover" />
                  <div className="w-10 h-10 bg-[#111827] rounded-full border-2 border-[#FFFFFF] flex items-center justify-center">
                ...
                <div className="relative h-[625px]">
                  ...
                  <div className="absolute bottom-6 left-6 right-6 backdrop-blur-md bg-white/90 border border-white/20 rounded-xl p-4 shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1)]">
                    <div className="flex justify-between items-start mb-3">
                      ...
                      <div className="bg-[rgba(37, 99, 235,0.1)] px-2 py-1 rounded">
