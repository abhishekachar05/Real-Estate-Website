        ...
        <div className="mb-8 border-b border-[#F8FAFC] pb-8">
          ...
          <div className="relative mb-3">
            ...
            <input
              ...
              className="w-full bg-[#F8FAFC] border border-[#E2E8F0] rounded-lg pl-10 pr-4 py-3 font-manrope text-sm text-[#111827] placeholder:text-[#6B7280] focus:outline-none focus:border-[#2563EB] transition-all"
            />
          </div>
        </div>
              ...
              <button
                ...
                className={`flex-1 h-11 rounded-xl border font-manrope font-bold text-sm transition-all ${
                  selectedAvailability === avail.id
                    ...
                    : 'bg-white border-[#E2E8F0] text-[#6B7280] hover:border-[#2563EB] hover:text-[#2563EB]'
                }`}
              >
                {avail.label}
              </button>
              ...
              <button
                ...
                className={`flex-1 h-10 rounded-lg font-manrope font-bold text-sm border transition-all ${
                  bedrooms === num
                    ...
                    : 'bg-white border-[#E2E8F0] text-[#6B7280] hover:border-[#2563EB]'
                }`}
              >
              ...
              <label 
                ...
                className={`flex items-center gap-3 p-3 rounded-lg border cursor-pointer transition-all ${
                  selectedAmenities.includes(amenity)
                    ? 'bg-[rgba(37, 99, 235,0.05)] border-[#2563EB]'
