      ...
      <button
        ...
        className={`flex items-center gap-1.5 h-10 px-4 rounded-xl border font-manrope text-sm font-medium transition-colors duration-200 active:scale-[0.96] ${
          active
            ...
            : 'bg-white border-[#E2E8F0] text-[#374151] hover:border-[#2563EB]'
        }`}
      >
        {label}
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <div className="relative flex-1 min-w-[200px] max-w-[280px]">
            ...
            <input
              ...
              className="w-full h-10 bg-[#F8FAFC] border border-[#E2E8F0] rounded-xl pl-9 pr-3 font-manrope text-sm text-[#0F172A] placeholder:text-[#9CA3AF] focus:outline-none focus:border-[#2563EB] transition-[border-color]"
            />
            {location && (
          ...
          >
            <div className="p-4 space-y-4 w-[260px]">
              <p className="font-manrope font-semibold text-xs text-[#0F172A] uppercase tracking-wider">Price Range</p>
              <div className="flex justify-between font-space-mono text-sm text-[#2563EB] tabular-nums">
          ...
          >
            <div className="p-3 w-[200px]">
              <p className="font-manrope font-semibold text-xs text-[#0F172A] uppercase tracking-wider mb-3 px-1">Property Type</p>
          ...
          >
            <div className="p-3 w-[200px]">
              <p className="font-manrope font-semibold text-xs text-[#0F172A] uppercase tracking-wider mb-3 px-1">Bedrooms</p>
          ...
          <div ref={moreRef} className="relative">
            ...
            <AnimatePresence>
              {showMoreFilters && (
                ...
                >
                  <p className="font-manrope font-semibold text-xs text-[#0F172A] uppercase tracking-wider mb-3">Amenities</p>
          ...
          {activeCount > 0 && (
            <button
              onClick={handleReset}
              className="flex items-center gap-1 h-10 px-3 rounded-xl font-manrope text-sm text-[#6B7280] hover:text-[#2563EB] transition-colors duration-200"
            >
          ...
          <select
            ...
            className="h-10 bg-white border border-[#E2E8F0] rounded-xl px-3 pr-7 font-manrope text-sm text-[#0F172A] cursor-pointer focus:outline-none focus:border-[#2563EB] appearance-none transition-[border-color]"
            style={{
            ...
            {(['grid', 'list'] as const).map(m => (
              <button
                ...
                className={`w-8 h-8 flex items-center justify-center rounded-lg transition-all duration-200 ${
                  viewMode === m ? 'bg-white shadow-sm text-[#0F172A]' : 'text-[#6B7280]'
                }`}
              >
