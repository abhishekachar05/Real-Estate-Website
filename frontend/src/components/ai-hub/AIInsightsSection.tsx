    ...
    <section className="bg-white py-24">
      <div className="max-w-[1280px] mx-auto px-8">
        ...
        <div className="text-center mb-16">
          {/* Icon */}
          <div className="w-16 h-16 bg-[rgba(29, 78, 216,0.1)] rounded-full flex items-center justify-center mx-auto mb-6">
            <Brain className="w-8 h-8 text-[#2563EB]" strokeWidth={1.5} />
          </div>

          <h2 className="font-syne text-4xl text-[#0F172A] mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {insights.map((insight, index) => (
            <div 
              key={index}
              className="bg-[#FFFFFF] border border-[#E2E8F0] rounded-xl p-8 hover:shadow-xl transition-all group"
            >
              {/* Icon */}
              <div className="w-12 h-12 bg-[rgba(29, 78, 216,0.1)] rounded-full flex items-center justify-center mb-6 group-hover:bg-[rgba(29, 78, 216,0.15)] transition-[background-color]">
                <insight.icon className="w-6 h-6 text-[#2563EB]" strokeWidth={1.5} />
              </div>

              {/* Title */}
              <h3 className="font-syne text-xl text-[#0F172A] mb-4">
                {insight.title}
              </h3>
