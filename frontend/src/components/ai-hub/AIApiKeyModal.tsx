        ...
        <div className="px-6 py-5">
          <div className="flex items-center justify-between mb-1.5">
            <div className="flex items-center gap-2">
              ...
              <span className="font-manrope text-[9px] text-[#2563EB]/70 uppercase">required</span>
            </div>
            <a
              href="https://firecrawl.dev"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-1 font-manrope text-[11px] text-[#2563EB] hover:text-[#e88a6f] transition-[color]"
            >
