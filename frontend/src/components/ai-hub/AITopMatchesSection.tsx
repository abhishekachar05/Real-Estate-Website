    ...
    <section className="bg-[#F2EFE9] py-24">
      <div className="max-w-[1280px] mx-auto px-8">
        ...
        <div className="flex items-center justify-between mb-10">
          ...
          <button className="font-space-mono text-sm text-[#0F172A] border-b border-[#0F172A] hover:text-[#2563EB] hover:border-[#2563EB] transition-[color,border-color] pb-1">
            View All → See more
          </button>
        </div>
              ...
              <div className="p-6">
                ...
                <div className="flex items-center divide-x divide-[rgba(230,224,218,0.5)] border-t border-[rgba(230,224,218,0.5)] pt-4">
                  <div className="flex-1 text-center">
                    <div className="font-syne text-base text-[#0F172A] mb-1">
                      {property.beds}
                    </div>
