  ...
  return (
    <div className="bg-white border border-[#E2E8F0] rounded-2xl p-6 space-y-5 mt-15">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h2 className="font-syne text-base font-bold text-[#0F172A] leading-tight">
            AI Market Analysis
          </h2>
      ...
      {/* ── Best value pick ───────────────────────────── */}
      {analysis.best_value && (
        <div className="relative bg-gradient-to-br from-[#0F172A] via-[#3d2519] to-[#0F172A] overflow-hidden rounded-xl p-5 flex flex-col gap-3 shadow-lg">
      ...
      {analysis.recommendations?.length > 0 && (
        <div className="bg-[#FFFFFF] border border-[#E2E8F0] rounded-xl p-5">
          <h3 className="font-syne text-sm font-bold text-[#0F172A] mb-3 flex items-center gap-2 pb-3 border-b border-[#E2E8F0]/60">
