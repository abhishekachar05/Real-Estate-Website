    ...
    <section className="relative">
      ...
      <div className="relative bg-[#FFFFFF] overflow-hidden">
        <div className="absolute inset-0 pointer-events-none" aria-hidden>
          <div className="absolute top-0 inset-x-0 h-[500px] bg-gradient-to-b from-[#2563EB]/8 to-transparent" />
          <div className="absolute -top-24 right-0 w-[480px] h-[480px] bg-[#2563EB]/8 rounded-full blur-[100px]" />
        </div>

        <div className="relative max-w-[1200px] mx-auto px-6 pt-32 pb-14">
          <div className="text-center max-w-[760px] mx-auto">
            <h1 className="font-fraunces text-4xl md:text-5xl lg:text-6xl leading-tight text-[#0F172A] mb-6 [text-wrap:balance]">
          ...
          <div className="mt-10 grid grid-cols-1 sm:grid-cols-3 gap-3 max-w-[880px] mx-auto">
            {[
              ...
              <div key={s.n} className="flex items-start gap-3 bg-white border border-[#E2E8F0] rounded-xl px-4 py-3.5">
                <span className="font-fraunces text-xl text-[#2563EB] leading-none mt-0.5">{s.n}</span>
                <div className="text-left">
                  <p className="font-manrope text-sm font-semibold text-[#0F172A]">{s.title}</p>
      ...
      <div className="bg-[#FFFFFF] px-6 pt-10 pb-24">
                ...
                <button
                  ...
                  className={`flex-1 min-w-[140px] text-left px-4 py-3 rounded-xl border text-sm transition-all ${
                    selectedModel === m.slug
                      ? 'bg-[#0F172A] border-[#2563EB] text-white shadow-md'
                      : 'bg-white border-[#E2E8F0] text-[#6B7280] hover:border-[#2563EB]/50 hover:text-[#1C1B1A]'
                  }`}
                >
                  <div className="font-semibold text-sm mb-0.5">{m.name}</div>
                  {m.badge && (
                    <div className={`text-[10px] font-medium ${selectedModel === m.slug ? 'text-[#2563EB]' : 'text-[#9CA3AF]'}`}>
                      {m.badge}
                    </div>
                  )}
                </button>
        ...
        <div className="max-w-[900px] mx-auto relative z-10">
          ...
          >
            {/* City */}
            <div className="mb-6">
              <label className="block font-manrope text-sm font-semibold text-[#0F172A] mb-2 ml-1">
                Where do you want to live?
              </label>
              <div className="relative">
                <div className="relative bg-white border border-[#E2E8F0] rounded-xl p-4 flex items-center gap-3 focus-within:ring-2 focus-within:ring-[#2563EB]/30 focus-within:border-[#2563EB] transition-all shadow-sm">
                  ...
                  <input
                    ...
                    className="flex-1 bg-transparent font-manrope text-base text-[#0F172A] outline-none placeholder:text-[#9CA3AF] placeholder:font-light"
                    ...
                    {filteredCities.map((c, idx) => (
                      <button
                        ...
                        className={`w-full text-left px-5 py-3.5 flex items-center gap-3 transition-[background-color,color] ${idx === highlightedIndex
                          ...
                          : 'text-[#6B7280] hover:bg-[#FFFFFF] hover:text-[#0F172A]'
                          }`}
                      >
                ...
                {POPULAR_CITIES.map((c) => (
                  <button
                    ...
                    className={`font-manrope text-sm px-4 py-2 rounded-full border transition-all ${city === c
                      ...
                      : 'bg-white border-[#E2E8F0] text-[#6B7280] hover:border-[#2563EB]/50 hover:text-[#2563EB]'
                      }`}
                  >
                    {c}
                  </button>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-8">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  <label className="font-manrope text-sm font-semibold text-[#0F172A] ml-1">
                    Max Budget
                  </label>
                  {/* Unit toggle */}
                ...
                <div className="relative bg-white border border-[#E2E8F0] rounded-xl p-4 flex items-center gap-3 focus-within:ring-2 focus-within:ring-[#2563EB]/30 focus-within:border-[#2563EB] transition-all shadow-sm">
                  ...
                  <input
                    ...
                    className="flex-1 bg-transparent font-space-mono text-base text-[#0F172A] outline-none placeholder:text-[#9CA3AF] [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
              ...
              <div>
                ...
                <div className="relative bg-white border border-[#E2E8F0] rounded-xl p-4 flex items-center gap-3 focus-within:ring-2 focus-within:ring-[#2563EB]/30 focus-within:border-[#2563EB] transition-all shadow-sm">
                  ...
                  <select
                    ...
                    className="flex-1 bg-transparent font-manrope text-base text-[#0F172A] outline-none cursor-pointer"
                  >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-8">
              <div>
                <label className="block font-manrope text-sm font-semibold text-[#0F172A] mb-3 ml-1">
                  BHK Configuration
                </label>
                    ...
                    <button
                      ...
                      className={`font-manrope text-sm font-medium px-4 py-2 rounded-xl border transition-all ${
                        possession === opt.value
                          ...
                          : 'bg-white border-[#E2E8F0] text-[#6B7280] hover:border-[#0F172A]/30 hover:text-[#0F172A]'
                      }`}
                    >
                      {opt.label}
                    </button>
            ...
            <div className="relative group mt-2">
              ...
              {!keysReady && !loading && (
                <div className="absolute -top-12 left-1/2 -translate-x-1/2 hidden group-hover:block bg-[#0F172A] border border-[#E2E8F0]/20 text-white font-manrope text-xs rounded-lg px-4 py-2 whitespace-nowrap pointer-events-none shadow-xl z-10 transition-opacity">
                  Add your free Firecrawl key first
                  <div className="absolute -bottom-1 left-1/2 -translate-x-1/2 w-2 h-2 bg-[#0F172A] border-b border-r border-[#E2E8F0]/20 rotate-45" />
                </div>
              )}
            </div>
                  ...
                  {LOAD_STEPS.map((s, i) => {
                    ...
                    return (
                      <div key={s.label} className={`flex items-start gap-3 transition-opacity duration-500 ${isPending ? 'opacity-35' : 'opacity-100'}`}>
                        ...
                        <div>
                          <p className={`font-manrope text-sm font-semibold ${isDone ? 'text-[#6B7280] line-through decoration-[#9CA3AF]' : isActive ? 'text-[#0F172A]' : 'text-[#9CA3AF]'}`}>
                            {s.label}{isActive ? '…' : ''}
                          </p>
                          {isActive && (
