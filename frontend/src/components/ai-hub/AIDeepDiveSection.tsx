    ...
    <section className="bg-white py-24">
      <div className="max-w-[1280px] mx-auto px-8">
        ...
        <div className="mb-12">
          ...
          <h2 className="font-syne text-4xl text-[#0F172A]">
            Deep Dive Analysis
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="bg-white border border-[#E2E8F0] rounded-xl overflow-hidden shadow-lg">
            ...
            <div className="relative aspect-[382/286.5] overflow-hidden">
              ...
              <div className="absolute bottom-4 left-4 backdrop-blur-md bg-white/90 border border-[#E2E8F0] rounded px-3 py-2 shadow-lg">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-space-mono text-xs text-[#0F172A] font-bold">
                    97% Match
                  </span>
                </div>
              </div>
            ...
            {/* Market Badge */}
            <div className="bg-[rgba(37, 99, 235,0.1)] border-b border-[rgba(37, 99, 235,0.2)] px-6 py-4 flex items-center justify-between">
            ...
            {/* Property Details */}
            <div className="p-6">
              <h3 className="font-syne text-xl text-[#0F172A] mb-2">
                The Eames Retreat
              </h3>
              ...
              <p className="font-manrope font-extralight text-sm leading-relaxed text-[rgba(15, 23, 42,0.6)] mb-6">
              ...
              <div className="flex items-center divide-x divide-[rgba(230,224,218,0.5)] border-t border-[rgba(230,224,218,0.5)] pt-4">
                <div className="flex-1 text-center">
                  <div className="font-syne text-base text-[#0F172A] mb-1">4</div>
                  <div className="font-manrope font-extralight text-xs text-[rgba(15, 23, 42,0.5)] uppercase tracking-wide">
                    Beds
                  </div>
                </div>
                <div className="flex-1 text-center">
                  <div className="font-syne text-base text-[#0F172A] mb-1">3</div>
                  <div className="font-manrope font-extralight text-xs text-[rgba(15, 23, 42,0.5)] uppercase tracking-wide">
                    Baths
                  </div>
                </div>
                <div className="flex-1 text-center">
                  <div className="font-syne text-base text-[#0F172A] mb-1">2.8k</div>
                  <div className="font-manrope font-extralight text-xs text-[rgba(15, 23, 42,0.5)] uppercase tracking-wide">
                    Sqft
                  </div>
                </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-[#FFFFFF] border border-[#E2E8F0] rounded-xl p-6">
              <h3 className="font-syne text-lg text-[#0F172A] mb-6">
                Market Scoring
              </h3>
                ...
                {analysisData.marketScoring.map((item, index) => (
                  <div key={index}>
                    <div className="flex items-center justify-between mb-2">
                      <span className="font-manrope font-extralight text-sm text-[#0F172A]">
                        {item.label}
                      </span>
