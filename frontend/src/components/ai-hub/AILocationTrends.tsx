    ...
    <section className="bg-[#FFFFFF] py-20 border-t border-[#E2E8F0]/50 relative">
      ...
      <div className="max-w-[1200px] mx-auto px-6 relative z-10">
        ...
        <div className="flex items-center gap-4 mb-10">
          ...
          <div>
            <h2 className="font-syne text-3xl font-bold text-[#0F172A] mb-1">
                    ...
                    >
                      <td className="px-8 py-5">
                        <div className="flex items-center gap-3">
                          <MapPin className="w-4 h-4 text-[#2563EB]/60 group-hover:text-[#2563EB] transition-[color]" />
                          <span className="font-manrope text-[15px] text-[#0F172A] font-semibold">
                            {loc.location}
                          </span>
                        </div>
                      </td>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            {analysis.trends?.length > 0 && (
              <div className="bg-white border border-[#E2E8F0] shadow-sm rounded-2xl p-8">
                <h3 className="font-syne text-xl font-bold text-[#0F172A] mb-6 flex items-center gap-2.5">
                ...
                <div className="space-y-4">
                  {analysis.trends.map((trend, i) => {
                    ...
                    return (
                      <div key={i} className="bg-[#FFFFFF] border border-[#E2E8F0]/60 rounded-xl p-5 hover:border-[#2563EB]/30 transition-[border-color]">
                        <div className="flex items-start justify-between mb-4">
                          {/* Location name */}
                          <h4 className="font-syne text-[17px] font-bold text-[#0F172A]">
                            {trend.location}
                          </h4>
                        ...
                        <div className="grid grid-cols-3 gap-2">
                          <div className="bg-white rounded-lg border border-[#E2E8F0]/50 p-3 text-center">
                            ...
                            <span className="font-manrope font-semibold text-[#0F172A] text-[15px]">
            ...
            <div className="space-y-6">
              ...
              {analysis.investment_tips?.length > 0 && (
                <div className="bg-white border border-[#E2E8F0] shadow-sm rounded-2xl p-7 relative overflow-hidden">
                  <h3 className="font-syne text-xl font-bold text-[#0F172A] mb-5">
                    Investment Tips
                  </h3>
