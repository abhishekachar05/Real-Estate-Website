...
import { searchProperties, getLocationTrends, getLocalitySuggestions, createUserListing, getUserListings, getUserListingById, updateUserListing, deleteUserListing, validateApiKeys, getCacheStats } from '../controller/propertyController.js';
...
router.get('/user/properties/:id', protect, getUserListingById);
