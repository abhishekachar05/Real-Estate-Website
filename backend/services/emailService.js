...
class EmailService {
  ...
  async sendWelcomeEmail(userEmail, userName) {
    const subject = 'Welcome to Propert-E - Your Account is Ready!';
  ...
  async sendEmailVerification(userEmail, userName, verificationUrl) {
    const subject = 'Verify Your Propert-E Email Address';
  ...
  async sendPasswordResetEmail(userEmail, resetUrl) {
    const subject = 'Reset Your Propert-E Password';
  ...
  async sendUserSuspended(userEmail, userName, days, reason, suspendedUntil) {
    const subject = `Propert-E Account Suspended - ${days} Day${days > 1 ? 's' : ''}`;
  ...
  async sendUserBanned(userEmail, userName, reason) {
    const subject = 'Propert-E Account Permanently Banned';
  ...
  async sendUserReactivated(userEmail, userName) {
    const subject = 'Propert-E Account Reactivated - Welcome Back!';
